...
def anytime_potential_search(grid, start, goal, initial_budget, cost_model, h, epsilon=5):
    best_path = None
    best_cost = math.inf
    best_open = None
    best_close = None
...
if __name__ == "__main__":
    ...
    best_path, best_open, best_close, best_cost = anytime_potential_search(grid, start, goal, initial_budget, cost_model, pt.heuristic_manhattan)
